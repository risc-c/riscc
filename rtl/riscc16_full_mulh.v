// riscc16_full_mulh.v : RISC-C/16 Full MUL+MULHU option.
//
...
`endif
    ...
    localparam ST_ITERATION_OPERAND_LOAD     = 12; // shift/MUL operand stage
    localparam ST_ITERATE                    = 13; // shift/MUL iteration
