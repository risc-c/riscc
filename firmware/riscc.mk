# RISC-C/full tool and runtime settings for application Makefiles.
#
...
# uses the visible variables below in its own commands.
...
RISCC_RUNTIME_DIR ?= $(RISCC_ROOT)/build/firmware
...
RISCC_LIBRARIES := $(RISCC_RUNTIME_DIR)/libirq.a \
	$(RISCC_RUNTIME_DIR)/libbuiltins.a $(RISCC_RUNTIME_DIR)/libc.a
